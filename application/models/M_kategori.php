...
class M_kategori extends CI_Model {
	...
	public function json() {
		$this->datatables->select('id,nama,gambar,deskripsi,spesifikasi,slug');
		$this->datatables->from($this->table);
		$this->datatables->add_column('view', '<div align="center">
			<a class="btn btn-warning btn-rounded btn-sm" href="'.site_url('admin/kategori/edit/$1').'" ><span class="fa fa-edit"></span></a>
