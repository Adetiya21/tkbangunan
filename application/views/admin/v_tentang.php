                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>TENTANG TOKO</h4>
                                        <span>Berikut data infomasi tentang toko.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?= site_url('admin/tentang') ?>">Toko</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="card">
							...
							<div class="card-block">
		                        ...
		                        <?= form_open('admin/tentang/proses',$arb); ?>
		                        	<input type="hidden" value="<?= $tentang->id_toko ?>" name="id_toko">
		                        	<div class="form-group row">
										<label class="col-sm-2 col-form-label">Nama Toko</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" value="<?= $tentang->nama ?>" name="nama" placeholder="Masukkan Nama Toko">
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-10">
							                ...
							                <img id="uploadPreview" style="max-width:300px; height:150px; border-radius: 10px; box-shadow: 0px 0px 3px 0px;" src="<?= base_url('assets/back-end/images/logo/') ?><?= $tentang->gambar ?>" />
							            </div>
									</div>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">Deskripsi Toko</label>
										<div class="col-sm-10">
											<textarea class="form-control" name="deskripsi" rows="3" id="editor1"><?= $tentang->deskripsi ?></textarea>
										</div>
									</div>
									<br>
									<h5>Kontak</h5>
									<hr>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">Keterangan Toko</label>
										<div class="col-sm-10">
											<textarea class="form-control" name="keterangan" rows="3" id="editor2"><?= $tentang->keterangan ?></textarea>
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">Email Toko</label>
										<div class="col-sm-10">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" value="<?= $tentang->ig ?>" name="ig" placeholder="Masukkan Nama Instagram">
										</div>
									</div>
									<div class="form-group row">
