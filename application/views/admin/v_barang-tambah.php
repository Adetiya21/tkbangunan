                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>TAMBAH BARANG</h4>
                                        <span>Berikut form tambah data barang.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?= site_url('admin/barang/tambah') ?>">Tambah Barang</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="page-body">
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <?= form_open('admin/barang/proses',$arb); ?>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <span>Pastikan tidak menggunakan simbol (*/?^)</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="number" min="1" class="form-control" placeholder="Stok" name="stok_barang" style="width:100px">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8 col-lg-10">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Harga Barang per Satuan" name="harga_barang" maxlength="8" onkeypress='return check_int(event)' >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control" name="deskripsi" rows="3" id="editor1"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <img id="uploadPreview" style="max-width:450px; height:250px; border-radius: 10px; box-shadow: 0px 0px 3px 0px;" src="<?= base_url('assets/assets/img/produk/') ?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
