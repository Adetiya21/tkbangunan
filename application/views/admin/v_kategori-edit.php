			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/kategori') ?>">Edit Kategori Produk</a>
						</li>
					</ul>
				</div>
			</div>
						...
						<div class="card-block">
							<div id="wizard">
								<section>
									...
									<?= form_open('admin/kategori/proses_edit',$arb); ?>
									<input type="hidden" name="id" value="<?= $kategori->id ?>">
				                    <div class="form-group row">
				                      <label class="col-sm-2 col-form-label">Nama Kategori</label>
				                      <div class="col-sm-10">
				                        <input type="text" class="form-control" placeholder="Nama Kategori Produk" name="nama" value="<?= $kategori->nama ?>">
				                      </div>
				                    </div>
				                    <div class="form-group row">
				                      <label class="col-sm-2 col-form-label">Deskripsi Singkat</label>
				                      <div class="col-sm-10">
				                        <textarea class="form-control" name="deskripsi" rows="3" placeholder="Deskripsi Singkat"><?= $kategori->deskripsi ?>
				                        </textarea> 
				                      </div>
				                    </div>
				                    <div class="form-group row">
				                      ...
				                      <div class="col-sm-10">
				                        <textarea class="form-control" name="spesifikasi" rows="1" id="editor1" placeholder="Spesifikasi Produk"><?= $kategori->spesifikasi ?>
				                        </textarea> 
				                      </div>
				                    </div>
				                    <div class="form-group row">
				                      ...
				                      <div class="col-sm-10">
				                        ...
				                        <div class="form-group" id="photo-preview"></div>
			                                ...
			                                <img id="uploadPreview" style="width:300px; height:280px; border-radius: 10px; box-shadow: 0px 0px 3px 0px;" src="<?= base_url('assets/assets/img/kategori/'.$kategori->gambar) ?>" />
