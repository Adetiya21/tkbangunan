...
<script src="<?=base_url('assets/back-end') ?>/files/assets/js/jquery.mCustomScrollbar.concat.min.js" type="text/javascript"></script>
<script type="text/javascript" src="<?=base_url('assets/back-end') ?>/files/assets/js/script.js"></script>
...
<script src="<?=base_url('assets/back-end') ?>/ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="389eeea26b2c44da98983ba3-|49" defer=""></script></body>
</html>