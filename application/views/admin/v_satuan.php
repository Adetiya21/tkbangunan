                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        <h4>SATUAN BARANG</h4>
                                        <span>Berikut daftar satuan barang.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?= site_url('admin/satuan') ?>">Satuan Barang</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="page-body">
                        <div class="card">
                            <div class="card-header">
                                <h5>Daftar Data Satuan Barang</h5>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/satuan/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("admin/satuan/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function tambah()
    {
        ...
        $('.modal-title').text('Tambah Data Satuan'); // Set Title to Bootstrap modal title
    }
    ...
    function edit(id)
    {
	    ...
	    $('.help-block').empty(); // clear error string
	    $.ajax({
	        url : '<?php echo site_url("admin/satuan/edit/'+id+'") ?>',
	        type: "GET",
	        dataType: "JSON",
	        success: function(data)
	        {
