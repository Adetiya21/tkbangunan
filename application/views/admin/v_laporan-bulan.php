                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <div class="dt-responsive">
                                    <h4>Jumlah Pemasukan Bulan <?php if($bln=='01') { 
                                    	echo "Januari"; } else if($bln=='02') { 
                                    	echo "Febuari"; } else if($bln=='03') { 
                                    	echo "Maret"; } else if($bln=='04') { 
                                    	echo "April"; } else if($bln=='05') { 
                                    	echo "Mei"; } else if($bln=='06') { 
                                    	echo "Juni"; } else if($bln=='07') { 
                                    	echo "Juli"; } else if($bln=='08') { 
                                    	echo "Agustus"; } else if($bln=='09') { 
                                    	echo "September"; } else if($bln=='10') { 
                                    	echo "Oktober"; } else if($bln=='11') { 
                                    	echo "November"; } else if($bln=='12') { 
                                    	echo "Desember"; }  ?>
                                    	: <?php if($laporan->total!=null) { 
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/laporan/json_bulan/<?= $bln ?>", "type": "POST"},
        columns: [
        {
            "data": "id_invoice",
            "orderable": false
